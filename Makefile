...
$(TARGET): src/main.o src/api.o src/posts.o src/list.o
	$(CC) $(LDFLAGS) $(CFLAGS) $^ -o $@ $(LDLIBS)

main.o: src/main.c src/api.c include/api.h src/posts.c include/posts.h src/list.c include/list.h
	$(CC) $(CFLAGS) -c $<

api.o: src/api.c include/api.h
	$(CC) $(CFLAGS) -c $<

posts.o: src/posts.c include/posts.h
	$(CC) $(CFLAGS) -c $<
